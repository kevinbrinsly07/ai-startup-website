...
export default function Pricing() {
  return (
    <div className="flex flex-co relative justify-center items-center py-20 bg-black -z-20 xl:px-0 px-10">
      <div className="max-w-[1300px] w-full text-center flex flex-col justify-center items-center">
        ...
        <div className="relative mt-10 flex xl:flex-row flex-col justify-between max-w-[941px] w-full">
          {/* 1st card */}
          <div className="xl:w-[307px] w-full h-[500px] bg-[#000000]/[6%] flex flex-col justify-between border-[1px] border-[#FFFFFF]/[15%] rounded-[10px] p-5 text-start">
            <div>
          ...
          {/* 2nd card */}
          <div className="relative xl:w-[307px] w-full h-[500px] bg-[#000000]/[6%] flex flex-col justify-between border-[1px] border-[#FFFFFF]/[15%] rounded-[10px] p-5 text-start">
            <div className="z-10">
          ...
          <div className="absolute xl:block hidden left-1/2 -translate-x-1/2 -z-10">
